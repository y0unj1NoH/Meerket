...
import { TransactionSellTemplate } from ".";
import { DEFAULT_IMG_PATH } from "constants/imgPath";
import { IPost } from "components/organisms/PostList";

const meta: Meta<typeof TransactionSellTemplate> = {
  title: "Templates/TransactionSellTemplate",
  component: TransactionSellTemplate,
  tags: ["autodocs"],
};
