...
import { ChatRoomTemplate } from ".";
import { DEFAULT_IMG_PATH } from "constants/imgPath";

const meta: Meta<typeof ChatRoomTemplate> = {
  title: "Templates/ChatRoomTemplate",
...
export const Default: Story = {
  args: {
    post: {
      ...
      price: 350000,
      address: "신림동",
      uploadTime: `2024-11-28 11:00:00`, // 시간에 변화를 주기 위해 설정
      onClick: () => {
        console.log(`클릭`);
      },
      expiredTime: `2024-12-29 11:00:00`,
      maxPrice: 30000,
      onTextButtonClick: () => {
